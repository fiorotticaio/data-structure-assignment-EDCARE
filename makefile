...
edcare: idoso cuidador listas
	@ gcc -o edcare Idoso.o Cuidador.o Lista_I.o Lista_C.o main.c -lm
	@ echo "\033[1;32m[construtor] \033[mArquivo prog gerado com sucesso! ✅"
